...
static const struct cci_reg_sequence full_1600_1400_1500_12b_2lanes_reg_new[] = {
 ...
 static int mira220_write_exposure_reg(struct mira220 *mira220, u32 exposure) {
	...
	//  printk(KERN_INFO "[MIRA220]: HIGH EXP Read reg %d, otherval= %d\n",
	 ...
	 ret = cci_write(mira220->regmap, MIRA220_EXP_TIME_REG,
		capped_exposure, NULL);
 ...
 static int mira220_set_ctrl(struct v4l2_ctrl *ctrl)
 {
	...
	case V4L2_CID_VBLANK:
		ret = cci_write(mira220->regmap, MIRA220_VBLANK_REG,
					ctrl->val, NULL);
 ...
 static int mira220_set_framefmt(struct mira220 *mira220)
 {
	...
	case MEDIA_BUS_FMT_SGRBG8_1X8:
		...
		cci_write(mira220->regmap, MIRA220_BIT_DEPTH_REG, MIRA220_BIT_DEPTH_8_BIT, NULL);
		cci_write(mira220->regmap, MIRA220_CSI_DATA_TYPE_REG, MIRA220_CSI_DATA_TYPE_8_BIT, NULL);
		return 0;
	case MEDIA_BUS_FMT_Y10_1X10:
	case MEDIA_BUS_FMT_SGRBG10_1X10:
		printk(KERN_INFO "[MIRA220]: mira220_set_framefmt() write 10 bpp regs.\n");
		cci_write(mira220->regmap, MIRA220_BIT_DEPTH_REG, MIRA220_BIT_DEPTH_10_BIT, NULL);
		cci_write(mira220->regmap, MIRA220_CSI_DATA_TYPE_REG, MIRA220_CSI_DATA_TYPE_10_BIT, NULL);

		return 0;
	case MEDIA_BUS_FMT_Y12_1X12:
	case MEDIA_BUS_FMT_SGRBG12_1X12:
		printk(KERN_INFO "[MIRA220]: mira220_set_framefmt() write 12 bpp regs.\n");
		cci_write(mira220->regmap, MIRA220_BIT_DEPTH_REG, MIRA220_BIT_DEPTH_12_BIT, NULL);
		cci_write(mira220->regmap, MIRA220_CSI_DATA_TYPE_REG, MIRA220_CSI_DATA_TYPE_12_BIT, NULL);
 ...
 static int mira220_start_streaming(struct mira220 *mira220)
 {
	...
	ret = cci_multi_reg_write(mira220->regmap, reg_list->regs, reg_list->num_of_regs, NULL);
 ...
 static int mira220_otp_power_on(struct mira220 *mira220)
 {
	 ...
	 ret = cci_write(mira220->regmap, MIRA220_OTP_CMD_REG, MIRA220_OTP_CMD_UP, NULL);
 ...
 static int mira220_otp_power_off(struct mira220 *mira220)
 {
	 ...
	 ret = cci_write(mira220->regmap, MIRA220_OTP_CMD_REG, MIRA220_OTP_CMD_DOWN, NULL);
 ...
 static int mira220_otp_read(struct mira220 *mira220, u8 addr, u8 offset, u8 *val)
 {
	 ...
	 u64 readback;
		...
		0x02, NULL);
         ret = cci_read(mira220->regmap, CCI_REG8(0x0082+offset),
		&readback, NULL);
	 *val = readback & 0xFF;
